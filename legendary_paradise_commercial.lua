...
-- ============================================================
-- USER KEY GENERATOR (HWID-based — each user gets unique key)
-- ============================================================
local function generateUserKey(hwid, dayOffset)
 local d = os.date("!*t")
 ...
 local combined = SECRET_SEED .. tostring(hwid)
 -- Pass 1
 local hash = 0
 for i = 1, #combined do
...
local function validateKey(inputKey)
 ...
 -- Check daily key (unique per HWID per day)
 local todayKey = generateUserKey(hwid, 0)
 ...
 local yesterdayKey = generateUserKey(hwid, -1)
